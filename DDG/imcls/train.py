...
def reset_cfg(cfg, args):
    ...
    # DDG-added
    if args.graph_conn:
        cfg.GRAPH_CONN = args.graph_conn
...
def extend_cfg(cfg):
    ...
    # DDG-added
    cfg.TRAINER.VANILLA3 = CN()
    cfg.TRAINER.VANILLA3.MIX = 'random' # random or crossdomain
...
if __name__ == '__main__':
    ...
    # DDG-added
    parser.add_argument(
        '--num-clients', type=int, default=3, help='number of clients in the decentralized setup'
    )
    # DDG-added
    parser.add_argument(
        '--graph-conn', type=float, default=2, help='radius of the random geometric graph'
    )
